...
public class TrackerController {
    ...
    public ResponseEntity<String> heartbeat(@RequestBody UUID peerId) {
        this.trackerService.heartbeat(peerId);
        return new ResponseEntity<>("Success", HttpStatus.OK);
    }

    @GetMapping("/peers")
    public ResponseEntity<Map<UUID, Set<UUID>>> getPeers(@RequestParam UUID songId) {
